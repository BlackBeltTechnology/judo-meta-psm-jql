...
public class JqlDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JqlDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSwitchExpressionAccess().getAlternatives_1(), "rule__SwitchExpression__Alternatives_1");
			builder.put(grammarAccess.getSwitchExpressionAccess().getBodyAlternatives_3_0(), "rule__SwitchExpression__BodyAlternatives_3_0");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getAlternatives_1(), "rule__SwitchConditionalExpression__Alternatives_1");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getAlternatives_3_0_0(), "rule__SwitchConditionalExpression__Alternatives_3_0_0");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getAlternatives_4_0_0(), "rule__SwitchConditionalExpression__Alternatives_4_0_0");
			builder.put(grammarAccess.getSwitchConditionalCaseAccess().getAlternatives_2(), "rule__SwitchConditionalCase__Alternatives_2");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getAlternatives_1_0_0(), "rule__SwitchEqualsExpression__Alternatives_1_0_0");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getAlternatives_2_0_0(), "rule__SwitchEqualsExpression__Alternatives_2_0_0");
			builder.put(grammarAccess.getSwitchEqualsCaseAccess().getAlternatives_2(), "rule__SwitchEqualsCase__Alternatives_2");
			...
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getGroup(), "rule__SwitchConditionalExpression__Group__0");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getGroup_3(), "rule__SwitchConditionalExpression__Group_3__0");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getGroup_3_0(), "rule__SwitchConditionalExpression__Group_3_0__0");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getGroup_4(), "rule__SwitchConditionalExpression__Group_4__0");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getGroup_4_0(), "rule__SwitchConditionalExpression__Group_4_0__0");
			builder.put(grammarAccess.getSwitchConditionalCaseAccess().getGroup(), "rule__SwitchConditionalCase__Group__0");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getGroup(), "rule__SwitchEqualsExpression__Group__0");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getGroup_1(), "rule__SwitchEqualsExpression__Group_1__0");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getGroup_1_0(), "rule__SwitchEqualsExpression__Group_1_0__0");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getGroup_2(), "rule__SwitchEqualsExpression__Group_2__0");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getGroup_2_0(), "rule__SwitchEqualsExpression__Group_2_0__0");
			builder.put(grammarAccess.getSwitchEqualsCaseAccess().getGroup(), "rule__SwitchEqualsCase__Group__0");
			...
			builder.put(grammarAccess.getSwitchExpressionAccess().getOperandAssignment_2(), "rule__SwitchExpression__OperandAssignment_2");
			builder.put(grammarAccess.getSwitchExpressionAccess().getBodyAssignment_3(), "rule__SwitchExpression__BodyAssignment_3");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getAliasAssignment_2(), "rule__SwitchConditionalExpression__AliasAssignment_2");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getCasesAssignment_3_1(), "rule__SwitchConditionalExpression__CasesAssignment_3_1");
			builder.put(grammarAccess.getSwitchConditionalExpressionAccess().getDefaultAssignment_4_1(), "rule__SwitchConditionalExpression__DefaultAssignment_4_1");
			builder.put(grammarAccess.getSwitchConditionalCaseAccess().getConditionAssignment_1(), "rule__SwitchConditionalCase__ConditionAssignment_1");
			builder.put(grammarAccess.getSwitchConditionalCaseAccess().getResultAssignment_3(), "rule__SwitchConditionalCase__ResultAssignment_3");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getCasesAssignment_1_1(), "rule__SwitchEqualsExpression__CasesAssignment_1_1");
			builder.put(grammarAccess.getSwitchEqualsExpressionAccess().getDefaultAssignment_2_1(), "rule__SwitchEqualsExpression__DefaultAssignment_2_1");
			builder.put(grammarAccess.getSwitchEqualsCaseAccess().getConditionAssignment_1(), "rule__SwitchEqualsCase__ConditionAssignment_1");
			builder.put(grammarAccess.getSwitchEqualsCaseAccess().getResultAssignment_3(), "rule__SwitchEqualsCase__ResultAssignment_3");
