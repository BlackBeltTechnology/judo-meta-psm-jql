...
public class JqlDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JqlDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFunctionAccess().getAlternatives_3(), "rule__Function__Alternatives_3");
			...
			builder.put(grammarAccess.getSwitchExpressionAccess().getGroup_1_0(), "rule__SwitchExpression__Group_1_0__0");
			builder.put(grammarAccess.getSwitchExpressionAccess().getGroup_1_0_0(), "rule__SwitchExpression__Group_1_0_0__0");
			...
			builder.put(grammarAccess.getImpliesExpressionAccess().getGroup_1_0(), "rule__ImpliesExpression__Group_1_0__0");
			builder.put(grammarAccess.getImpliesExpressionAccess().getGroup_1_0_0(), "rule__ImpliesExpression__Group_1_0_0__0");
			...
			builder.put(grammarAccess.getFunctionAccess().getGroup_3_1_1(), "rule__Function__Group_3_1_1__0");
			...
			builder.put(grammarAccess.getMeasuredLiteralAccess().getGroup_3(), "rule__MeasuredLiteral__Group_3__0");
			...
			builder.put(grammarAccess.getSwitchExpressionAccess().getThenExpressionAssignment_1_1(), "rule__SwitchExpression__ThenExpressionAssignment_1_1");
			builder.put(grammarAccess.getSwitchExpressionAccess().getElseExpressionAssignment_1_3(), "rule__SwitchExpression__ElseExpressionAssignment_1_3");
			builder.put(grammarAccess.getImpliesExpressionAccess().getOperatorAssignment_1_0_0_1(), "rule__ImpliesExpression__OperatorAssignment_1_0_0_1");
			builder.put(grammarAccess.getImpliesExpressionAccess().getRightOperandAssignment_1_1(), "rule__ImpliesExpression__RightOperandAssignment_1_1");
			...
			builder.put(grammarAccess.getXorExpressionAccess().getOperatorAssignment_1_0_0_1(), "rule__XorExpression__OperatorAssignment_1_0_0_1");
			...
			builder.put(grammarAccess.getFunctionAccess().getLambdaAssignment_3_0(), "rule__Function__LambdaAssignment_3_0");
			builder.put(grammarAccess.getFunctionAccess().getParametersAssignment_3_1_0(), "rule__Function__ParametersAssignment_3_1_0");
			builder.put(grammarAccess.getFunctionAccess().getParametersAssignment_3_1_1_1(), "rule__Function__ParametersAssignment_3_1_1_1");
			...
			builder.put(grammarAccess.getMeasuredLiteralAccess().getTypeAssignment_3_0(), "rule__MeasuredLiteral__TypeAssignment_3_0");
			builder.put(grammarAccess.getMeasuredLiteralAccess().getMeasureAssignment_4(), "rule__MeasuredLiteral__MeasureAssignment_4");
			builder.put(grammarAccess.getEnumLiteralAccess().getTypeAssignment_1(), "rule__EnumLiteral__TypeAssignment_1");
			builder.put(grammarAccess.getEnumLiteralAccess().getValueAssignment_3(), "rule__EnumLiteral__ValueAssignment_3");
